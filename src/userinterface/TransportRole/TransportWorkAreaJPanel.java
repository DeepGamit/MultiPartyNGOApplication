...
public class TransportWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateOrders(){
        ...
        model.setRowCount(0);
        System.out.println("Work Requests: "+transportOrganization.getWorkQueue().getWorkRequestList());
...
//     public void populateDateOrders(Date enter){
//        
//        DefaultTableModel model = (DefaultTableModel)assignedJTable.getModel();
//        
//        model.setRowCount(0);
...
//            if(wr instanceof VolunteerInventoryWorkRequest){
//                VolunteerInventoryWorkRequest request = (VolunteerInventoryWorkRequest) wr;
//                if(formatter.format(request.getPickupDate()) == formatter.format(enter)){
//                        
//                        Object[] row = new Object[6];
//                        row[0] = request;
//                        row[1] = request.getSender().getUsername();
...
//                        model.addRow(row);
//                        
//                        System.out.println(formatter.format(request.getPickupDate()));
//                        System.out.println(formatter.format(enter));
//                }
//     
//            }else{
//                HealthPharmacyWorkRequest request = (HealthPharmacyWorkRequest) wr;
